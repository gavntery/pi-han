...
with ( pm )
{
 ...
 //---------------------------------------------------------------------------------------
   ...
   with ( this.ScrollControl )
   {
      ...
      var Size=Preview.viewportWidth/1.5;
 ...
 // Enhancement parameters
   ...
   this.numberOfLayers_SpinBox.toolTip = this.numberOfLayers_Label.toolTip =
      "<b>Number of wavelet layers that will be removed to build large scales image.</b>";
   ...
   with ( this.SSAmount ) {
      ...
      toolTip = "<p>Small Scales intensity .</p>";
   ...
   with ( this.Amount ) {
      ...
      toolTip = "<p>Background intensity .</p>";
